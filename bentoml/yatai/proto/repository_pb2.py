...
_BENTOURI = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='temp_presigned_url', full_name='bentoml.BentoUri.temp_presigned_url', index=2,
